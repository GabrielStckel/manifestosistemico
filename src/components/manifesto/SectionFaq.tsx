    ...
    <SectionShell fundo={fundo}>
      <div>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <span aria-hidden className="mx-auto mt-6 block h-px w-12 bg-brass/60" />
        </div>
                ...
                >
                  ...
                  >
                    <div className="min-h-0">
                      <p className="pb-5 pr-2 text-justify hyphens-auto text-[14.5px] leading-relaxed text-section-light-fg/80 sm:pr-10 sm:text-[15px]">
                        {item.resposta}
                      </p>
                    </div>
                  </div>
