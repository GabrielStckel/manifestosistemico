      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            ...
            <h2 className="mt-4 text-pretty font-display font-semibold leading-[1.22] tracking-[-0.01em] text-section-dark-fg text-[clamp(1.25rem,5.4vw,1.85rem)] max-w-[18ch] sm:text-[clamp(1.4rem,5.8vw,2rem)] sm:max-w-[22ch] md:mt-5 md:max-w-3xl md:text-[clamp(1.8rem,3.4vw,2.5rem)] md:leading-[1.12]">
              {titulo}
            </h2>
