      ...
      <div className="relative z-10">
        <div className="mx-auto max-w-3xl text-center">
          <Reveal>
            ...
            <h2 className="mx-auto max-w-[18ch] text-pretty text-center font-display font-semibold leading-[1.22] tracking-[-0.01em] text-section-dark-fg text-[clamp(1.1rem,4.8vw,1.6rem)] sm:max-w-[22ch] sm:text-[clamp(1.25rem,5.2vw,1.8rem)] md:mt-5 md:max-w-3xl md:text-[clamp(1.8rem,3.4vw,2.5rem)] md:leading-[1.12]">
              {titulo}
            </h2>
